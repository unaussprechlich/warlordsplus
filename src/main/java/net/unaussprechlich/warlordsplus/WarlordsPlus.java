...
import net.unaussprechlich.mixin.MixinLoadingPlugin;
...
public class WarlordsPlus {
    ...
    public void preInit(FMLPreInitializationEvent event){
        if(!MixinLoadingPlugin.loaded) {
            //FMLLog.bigWarning("HudPixel Loading Plugin Failed To Load! Use -Dfml.coreMods.load=net.unaussprechlich.mixin.MixinLoadingPlugin as VM setting in dev env");
            //throw new IllegalStateException("HudPixel Loading Plugin Failed To Load! Use -Dfml.coreMods.load=net.unaussprechlich.mixin.MixinLoadingPlugin as VM setting in dev env");
        }
